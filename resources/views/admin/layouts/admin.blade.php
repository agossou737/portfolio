...
<body>
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-qualification">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('admin.qualification.index') }}">Tout</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-portfolio">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('admin.category.index') }}">Categorie</a></li>
                                <li class="nav-item"> <a class="nav-link"
              ...
              <button class="btn btn-block btn-lg btn-gradient-primary mt-4">+ Add a project</button>
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button class="btn btn-block btn-lg btn-danger mt-4">Déconnexion</button>
                            </form>
                            {{-- <div class="mt-4">
    ...
    <!-- SweetAlert Js    -->
    <script src="{{ asset('import/assets/lib/sweetalert2/dist/sweetalert2.all.min.js') }}"></script>
    <!-- SweetAlert Js    -->
