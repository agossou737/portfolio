...
@section('content')
    ...
    <form class="forms-sample" method="POST" action="{{ route('admin.setting.update', $setting->id) }}"
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputName1" name="about_title"
                                placeholder="Title" value="{{ $setting->about_title }}" required>
                        </div>
                    </div>
                    <div class="form-group">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="github_url"
                                        value="{{ $setting->github_url }}" required />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="freelance_url"
                                        value="{{ $setting->freelance_url }}" required />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="video_url" placeholder="Embded URL"
                                        value="{{ $setting->video_url }}" required />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="linkedin_url"
                                        value="{{ $setting->linkedin_url }}" required />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="contact_mail"
                                        value="{{ $setting->contact_mail }}" required />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
